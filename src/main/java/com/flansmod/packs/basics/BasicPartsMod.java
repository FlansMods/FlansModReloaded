...
public class BasicPartsMod
{
	...
	public static final RegistryObject<Item> STEEL_BLOCK_ITEM = ITEMS.register("aluminium_block", () -> new BlockItem(STEEL_BLOCK.get(), new Item.Properties()));
	...
	// Vehicle parts in Metal or Composite
	...
	public static final RegistryObject<Item> PART_FIBERGLASS_MECHANICAL_PARTS = 			FlansMod.Part(ITEMS, MODID, "fiberglass_mechanical_parts");
	public static final RegistryObject<Item> PART_PHANTEX_MECHANICAL_PARTS = 				FlansMod.Part(ITEMS, MODID, "phantex_mechanical_parts");
	public static final RegistryObject<Item> PART_CARBON_FIBER_MECHANICAL_PARTS = 			FlansMod.Part(ITEMS, MODID, "carbon_fiber_mechanical_parts");
	...
	public static final RegistryObject<Item> PART_FIBERGLASS_ARMOUR = 						FlansMod.Part(ITEMS, MODID, "fiberglass_armour");
	public static final RegistryObject<Item> PART_PHANTEX_ARMOUR = 							FlansMod.Part(ITEMS, MODID, "phantex_armour");
	public static final RegistryObject<Item> PART_CARBON_FIBER_ARMOUR = 					FlansMod.Part(ITEMS, MODID, "carbon_fiber_armour");
	...
	public static final RegistryObject<Item> PART_GOLD_UPPER_RECEIVER = 					FlansMod.Part(ITEMS, MODID, "gold_upper_receiver");
	...
	public static final RegistryObject<Item> PART_GOLD_LOWER_RECEIVER = 					FlansMod.Part(ITEMS, MODID, "gold_lower_receiver");
	...
	public static final RegistryObject<Item> PART_GOLD_BARREL = 							FlansMod.Part(ITEMS, MODID, "gold_barrel");
	...
	public static final RegistryObject<Item> PART_GOLD_STOCK = 								FlansMod.Part(ITEMS, MODID, "gold_stock");
	...
	public static final RegistryObject<Item> PART_GOLD_GRIP = 								FlansMod.Part(ITEMS, MODID, "gold_grip");
