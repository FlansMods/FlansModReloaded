// --------------------------------------------------------------------
// Credit: Simibubi of Create
// 	MIT License
// https://github.com/Creators-of-Create/Create/blob/mc1.18/dev/LICENSE
// --------------------------------------------------------------------
...
public class Matrix3d {
	...
	public Matrix3d fromTransform(@Nonnull Transform transform)
	{
		transform.Orientation.getAsMatrix4f(FloatBuffer.wrap(conversionBuffer));
		m00 = conversionBuffer[0];
		m01 = conversionBuffer[1];
		m02 = conversionBuffer[2];
		m10 = conversionBuffer[4];
		m11 = conversionBuffer[5];
		m12 = conversionBuffer[6];
		m20 = conversionBuffer[8];
		m21 = conversionBuffer[9];
		m22 = conversionBuffer[10];
		return this;
	}
	...
	public Matrix4f getAsMatrix4f() {
		...
		return new Matrix4f(FloatBuffer.wrap(conversionBuffer));
	}
